...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    script.async = true;
    script.src = 'https://embed.tawk.to/695768bc9d6aae197eabef23/1jdun28k2';
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-3 sm:gap-4">
              {Object.entries(pensionCalendar).map(([month, data]) => (
                <motion.div
                  ...
                  className={`relative p-4 rounded-xl border-2 transition-all duration-200 ${data.status === 'paid'
                ...
                >
                  <div className="text-center">
                    <div className={`text-sm font-semibold mb-2 ${data.status === 'paid'
                      ? 'text-red-600'
                      : data.status === 'available'
                        ? 'text-green-600'
                        : 'text-gray-500'
                    ...
                    <div className={`text-lg font-bold mb-1 ${data.status === 'paid'
                      ? 'text-red-700'
                      : data.status === 'available'
                        ? 'text-green-700'
                        : 'text-gray-600'
